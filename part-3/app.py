...
def home():
    student_name = "Anurag"
    movies = "Hera Pheri"
    return render_template('index.html', name=student_name,movies = movies)  # Pass variable to template as {{ name }}
...
def profile():
    user_data = {
        'name': 'Anurag',
        'age': 21,
        'course': 'Web Development,AI Enthusiast',
        'is_enrolled': True,
...
@app.route('/grades')
def grades():
    grade_list = [{'OS': 'A','CN':'A','Web Technology':'A'}]
